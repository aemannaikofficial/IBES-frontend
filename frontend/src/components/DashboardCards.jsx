...
const DashboardCards = ({ stats, applications = [] }) => {
  const teacherApps = applications.filter(a => 
    a.applicationType === 'Teacher Applicant' || a.applicationType === 'Teacher' || a.applicationType === 'Teacher Applicant Form'
  );
  const leaderApps  = applications.filter(a => 
    a.applicationType === 'Leader Module' || a.applicationType === 'Leader' || a.applicationType === 'Module Leader'
  );
